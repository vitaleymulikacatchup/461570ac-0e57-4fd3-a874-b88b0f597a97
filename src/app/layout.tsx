...
export const metadata: Metadata = {
  ...
  description: "Experience the biggest World Cup ever with 48 teams competing across the United States, Canada, and Mexico. Get tickets, team info, and match schedules.",
  keywords: "FIFA World Cup 2026, USA Canada Mexico, football soccer, World Cup tickets, 48 teams tournament",
  metadataBase: new URL("https://worldcup2026.com"),
  alternates: {
    canonical: "https://worldcup2026.com"
  },
  openGraph: {
    title: "2026 FIFA World Cup - USA, Canada & Mexico",
    description: "Experience the biggest World Cup ever with 48 teams competing across the United States, Canada, and Mexico.",
